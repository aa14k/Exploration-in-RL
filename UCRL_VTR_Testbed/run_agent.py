...
from agent import RLSVI, UCRL_VTR, UCBVI, PSRL, LSVI_UCB

K = 1000
agent = LSVI_UCB(make_riverSwim(epLen = 60, nState = 10),K,1.0) # c=0.1 seems to work, not too sure on how to set this at the moment
print(agent.name())
