...
As of 2/20/20, only PSRL, RLSVI, UCRL_VTR, and UC_MatrixRL have been properly debugged and optimized to run on the riverswim environment. UCBVI and LVSI_UCB still require further debugging but should run on RiverSwim and learn something.
